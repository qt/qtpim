...
QT_BEGIN_NAMESPACE
#define QT_CONTACTS_BACKEND_INTERFACE "com.nokia.qt.pim.contacts.enginefactory/1.0"
Q_DECLARE_INTERFACE(QtAddOn::Pim::QContactManagerEngineFactory, QT_CONTACTS_BACKEND_INTERFACE)
QT_END_NAMESPACE
